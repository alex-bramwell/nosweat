    ...
    return (
      <Card className={styles.settingsSection}>
        <div className={styles.connectHeader}>
          ...
          <span className={`${styles.connectStatusBadge} ${styles.connectStatusDefault}`}>
            Free
          </span>
        </div>
        ...
        <div className={styles.connectDetails}>
          <div className={styles.connectDetailItem}>
            <span className={styles.connectDetailLabel}>URL</span>
        ...
        <div style={{
          ...
          <p style={{ color: 'var(--color-muted)', fontSize: '0.875rem', margin: '0 0 0.75rem 0' }}>
          ...
          <p style={{ color: 'var(--color-accent)', fontSize: '0.875rem', fontWeight: 600, margin: 0 }}>
    ...
    <Card className={styles.settingsSection}>
      ...
      {currentDomain && (
        <div className={styles.connectDetails}>
          ...
          <div className={styles.connectDetailItem}>
            <span className={styles.connectDetailLabel}>Also available at</span>
