...
export const SAMPLE_WORKOUT: WorkoutDB = {
  ...
  description: 'A fast, classic conditioning workout. Push for a strong time with good form.',
...
const WORKOUT_TEMPLATES: Pick<WorkoutDB, 'title' | 'type' | 'description' | 'movements' | 'metcon' | 'warmup' | 'strength' | 'duration'>[] = [
  { title: 'Engine Builder', type: 'fortime', description: 'A fast, intense conditioning piece.', movements: ['Thrusters', 'Pull-Ups'], metcon: ['21 Thrusters (43/30 kg)', '21 Pull-Ups', '15 Thrusters', '15 Pull-Ups', '9 Thrusters', '9 Pull-Ups'], warmup: ['400m Row', 'PVC Pass-Throughs x 10'], strength: [], duration: '10 min cap' },
  ...
  { title: 'Long Grinder', type: 'fortime', description: 'Partition the reps however you like.', movements: ['Run', 'Pull-Ups', 'Push-Ups', 'Squats'], metcon: ['800m Run', '50 Pull-Ups', '100 Push-Ups', '150 Squats', '800m Run'], warmup: ['200m Jog', 'Arm Circles'], strength: [], duration: '40 min cap' },
  ...
  { title: 'Bodyweight AMRAP', type: 'amrap', description: '20 min AMRAP of classic bodyweight movements.', movements: ['Pull-Ups', 'Push-Ups', 'Air Squats'], metcon: ['5 Pull-Ups', '10 Push-Ups', '15 Air Squats'], warmup: ['400m Run', 'Kip Swings x 10'], strength: [], duration: '20 min' },
...
export const SAMPLE_SCHEDULE: GymScheduleEntry[] = [
  { id: 's-1', gym_id: '', day_of_week: 'monday', start_time: '6:00 AM', end_time: null, class_name: 'Group Training', coach_id: null, program_id: null, max_capacity: 20, is_active: true },
  ...
  { id: 's-3', gym_id: '', day_of_week: 'monday', start_time: '5:30 PM', end_time: null, class_name: 'Group Training', coach_id: null, program_id: null, max_capacity: 20, is_active: true },
  { id: 's-4', gym_id: '', day_of_week: 'tuesday', start_time: '6:00 AM', end_time: null, class_name: 'Group Training', coach_id: null, program_id: null, max_capacity: 20, is_active: true },
  ...
  { id: 's-6', gym_id: '', day_of_week: 'wednesday', start_time: '6:00 AM', end_time: null, class_name: 'Group Training', coach_id: null, program_id: null, max_capacity: 20, is_active: true },
  ...
  { id: 's-8', gym_id: '', day_of_week: 'wednesday', start_time: '5:30 PM', end_time: null, class_name: 'Group Training', coach_id: null, program_id: null, max_capacity: 20, is_active: true },
  { id: 's-9', gym_id: '', day_of_week: 'thursday', start_time: '6:00 AM', end_time: null, class_name: 'Group Training', coach_id: null, program_id: null, max_capacity: 20, is_active: true },
  ...
  { id: 's-11', gym_id: '', day_of_week: 'friday', start_time: '6:00 AM', end_time: null, class_name: 'Group Training', coach_id: null, program_id: null, max_capacity: 20, is_active: true },
  ...
  { id: 's-13', gym_id: '', day_of_week: 'saturday', start_time: '9:00 AM', end_time: null, class_name: 'Group Training', coach_id: null, program_id: null, max_capacity: 20, is_active: true },
];
...
export const SAMPLE_COACHES: CoachProfile[] = [
  {
    ...
    title: 'Head Coach',
    bio: 'Level 3 personal trainer with 8 years of coaching experience. Passionate about helping athletes reach their potential.',
    certifications: ['Level 3 Personal Trainer', 'USAW Sports Performance'],
  ...
  },
  {
    ...
    certifications: ['CSCS', 'Level 2 Strength Coach'],
  ...
  },
  {
    ...
    certifications: ['Level 2 Fitness Coach', 'Precision Nutrition'],
